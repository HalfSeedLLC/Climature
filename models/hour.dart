...
class Hour {
  ...
  factory Hour.fromMap(Map<String, dynamic> map) {
    return Hour(
      ...
      willItRain: map['willItRain'] as bool,
      chanceOfRain: map['chanceOfRain'] as int,
      willItSnow: map['willItSnow'] as bool,
      ...
      shortwaveSolarRadiation: map['shortwaveSolarRadiation'] as double,
      diffuseHorizontalRadiation: map['diffuseHorizontalRadiation'] as double,
    );
  }
