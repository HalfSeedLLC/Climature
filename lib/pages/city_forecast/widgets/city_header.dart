...
class _CityHeaderState extends State<CityHeader> {
  ...
  void didUpdateWidget(covariant CityHeader oldWidget) {
    ...
    if (widget.condition != oldWidget.condition && widget.condition.isNotEmpty) {
      _controller?.dispose();
      _initializeVideo();
    }
  }
  ...
  void _initializeVideo() {
    _controller = VideoPlayerController.asset(getWeatherVideoAsset(widget.condition),
          ...
          children: [
            Stack(
              children: [
                ...
                Container(color: WeatherColors.black.withOpacity(0.1)),
              ],
            ),
            SafeArea(
              child: Column(
                                      ...
                                      SizedBox(
                                        ...
                                        child: OverflowBox(
                                          ...
                                          child: Image.asset(
                                              width: 50,
                                              height: 50,
                                              getWeatherIconAsset(iconAsset: widget.iconAsset)),
                                        ),
                                      ),
                                    Padding(
                                      ...
                                      child: Text(widget.condition,
                                          style: Theme.of(context).textTheme.labelSmall!.copyWith(
                                              height: 1, fontSize: 18, color: WeatherColors.white)),
                                    )
                                  ],
                                ),
                                Padding(
                                  ...
                                  child: Wrap(
                                    ...
                                    children: [
                                      Text('H: ${widget.tempHi}°',
                                          style: Theme.of(context).textTheme.labelSmall!.copyWith(
                                              height: 1, fontSize: 15, color: WeatherColors.white)),
                                      const Icon(
                                        size: 7,
                                        Icons.circle,
                                        color: WeatherColors.white,
